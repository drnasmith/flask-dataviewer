...
class StandaloneApplication(gunicorn.app.base.BaseApplication):
    ...
    def load(self):
        ...
        pid_file = os.environ.get('PIDFILE', '/tmp/hd5imageservice.pid')                                  
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='HD5 Image Service')
    parser.add_argument('--workers', type=int, help='number of worker processes')
    parser.add_argument('--host', help='Host (default localhost)', default='127.0.0.1')
    parser.add_argument('--port', type=int, dest='port',help='Port (default 8080)', default=8080)
